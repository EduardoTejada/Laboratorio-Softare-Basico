...
#line 90 "atv3_sin.y"
    {
        ...
        (yyval.str) = strdup(comando); // Duplicar para uso posterior
        free((yyvsp[0].str));
        free(comando);
    }
